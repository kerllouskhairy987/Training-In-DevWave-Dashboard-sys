      ...
      <nav className="bg-white flex justify-between w-full h-20 md:px-10 px-5 py-5 md:gap-10 gap-3">
        <div className="searchbar relative md:w-1/2 h-10 rounded-lg flex items-center md:ml-0 ml-8 px-3 gap-2 text-[#8c8c8c] text-lg">
          ...
          <input
            ...
            className={`md:w-full md:h-full text-[var(--topbartext)] md:opacity-100 md:translate-y-0 outline-none border-none bg-white md:static absolute transition z-10 md:top-0 top-[65px] md:left-0 left-[-50px] w-[90dvw] rounded-3xl duration-500 px-5 py-3 placeholder:text-[#8c8c8c] md:block`}
          />
        </div>
